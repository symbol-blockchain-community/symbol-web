...
By using QR codes and URLs, we want to enable true Web3 and P2P transfers that are independent of the marketplace, making this wallet the gateway to the next generation of value exchange networks.
