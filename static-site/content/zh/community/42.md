---
title: 'Quest, a "pay-for-success" money throwing platform using Symbol'
description: >-
  Introducing Quest, a Blockchain-based "pay-for-success" money throwing
  platform
createdAt: '2023-02-05T03:09:46.174Z'
updatedAt: '2023-03-25T13:28:04.551Z'
publishedAt: '2023-02-05T03:14:25.819Z'
...
[QUEST](https://quest-bc.com/) is a "pay-for-success" throwaway platform.
...
QUEST uses a cryptographic payment system based on the Symbol blockchain to achieve this. Since transactions are made in virtual currency, there is no need to open a bank account to receive money.
...
When you create a Quest and report its progress, you will start to receive money by using Symbol as shown in the following screen. If it is a costly activity, use it to fund the activity, otherwise use it as encouragement or reward to complete the quest!
...
Upon completion of the quest, this vote will be finalized and if approved, the quest executor will receive a reward in the form of a throwaway.
